...
$tempQuery = "SELECT * from product_category where prodcat_id='7'";
...
if ($cat_stat == 'Active') {
    ...
    $query = "SELECT * from product where prodcat_id='7'";
...
<a href="singleproductpage.php?view=' . $row['product_id'] . '" style="background-color: #52944D; color: white; width: 100px;" class="btn btn-primary btn-sm">View</a>
    ...
    $output2 = '<h5><i class="fa fa-pizza-slice mr-2 ml-1"> </i>FAST FOOD</h5>';
} else {
