  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <center><a class="tablink" href="pending_orders.php">Pending</a>
        <a class="tablink" style="background-color: red;" href="process_orders.php">Processing</a>
...
FROM placed_order
INNER JOIN user ON placed_order.user_id = user.user_id WHERE placed_order.status='Processing';";
