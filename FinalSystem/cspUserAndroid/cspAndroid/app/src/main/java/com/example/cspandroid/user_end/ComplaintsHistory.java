...
public class ComplaintsHistory extends AppCompatActivity {


    private DrawerLayout var_drawer_layout;
    private Spinner spinner_service_history;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        var_drawer_layout = (DrawerLayout) findViewById(R.id.activity_complaints_history);
