...
public class FastFood extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        var_drawer_layout = (DrawerLayout) findViewById(R.id.activity_fast_food);
        fab_ic_more = (FloatingActionButton) findViewById(R.id.fab_ic_more);
        ic_cart_shop = (ImageView) findViewById(R.id.ic_cart_shop);

        gridView = findViewById(R.id.grid_view_ff);


//      check-1 START //////////////////////////////////////////////////////////////////////////////
        shopModalList = new ArrayList<>();
        shop_main_adapter = new ShopMainAdapter(FastFood.this, shopModalList);
...
//      check-1 END //////////////////////////////////////////////////////////////////////////////
    ...
    public void getData() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("function", "getFFProducts");
                return params;
            }
        };
        queue.add(request);
    ...
    public void openCatView(View view) {
        ...
        Toast.makeText(FastFood.this, "IC_more Clicked!!", Toast.LENGTH_SHORT).show();
    }
